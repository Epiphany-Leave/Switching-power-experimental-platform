...
{
    uint32 PWM_per = (int)(1152000000 / fre);
...
int main(void)
{
  ...
  float arm_abs_f32_get(float32_t Src)
	{
		float32_t output_abs;
		arm_abs_f32( &Src, &output_abs,1);
		return  output_abs;
	}
	  float arm_sqrt_f32_get(float32_t Src)
	{
		float32_t output_sqrt;
		arm_sqrt_f32( Src, &output_sqrt);
		return  output_sqrt;
	}
